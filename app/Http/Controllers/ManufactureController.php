...
class ManufactureController extends Controller
{
    ...
    public function unactive_manufacture($manufacture_id){
        ...
        DB::table('tbl_manufacture')
            ...
            Session::put('message' , 'manufacture unactivated succesfully');
    ...
    public function active_manufacture($manufacture_id){
        ...
        DB::table('tbl_manufacture')
            ...
            Session::put('message' , 'manufacture activated succesfully');
            return Redirect::to('/all-manufacture');
        ...
        public function update_manufacture(Request $request , $manufacture_id){
            ...
            Session::put('message' , 'manufacture info updated successsfully');
            return Redirect::to('/all-manufacture');
        }
        ...
        public function delete_manufacture($manufacture_id){
            ...
            Session::put('message' , 'manufacture info deleted successfully');
            return Redirect::to('/all-manufacture');
        }
