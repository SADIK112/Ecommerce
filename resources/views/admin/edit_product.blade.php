            ...
            {{ csrf_field() }}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_short_description" rows="40">{{$product_info->product_short_description}}</textarea>
							  </div>
							</div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="product_long_description" rows="40">{{$product_info->product_long_description}}</textarea>
							  </div>
							</div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="number" class="input-xlarge" name="product_price" value="{{$product_info->product_price}}"/>
							  </div>
							</div>
