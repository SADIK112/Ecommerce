						...
						@foreach($all_manufacture_info as $v_manufacture)   
						  <tbody>
							<tr>
								...
								<td class="center">
									@if($v_manufacture->publication_status == 1)
										<a class="btn btn-success" href="{{URL::to('/unactive-manufacture/'.$v_manufacture->manufacture_id)}}">
											<i class="halflings-icon white thumbs-up"></i>  
										</a>
									@else
									<a class="btn btn-danger" href="{{URL::to('/active-manufacture/'.$v_manufacture->manufacture_id)}}">
